...
if len(texto_1) > len(texto_2):
    print('{} es tiene mayor cantidad de letras que {}'.format(texto_1, texto_2))
elif len(texto_1) < len(texto_2):
    print('{} es tiene mayor cantidad de letras que {}'.format(texto_2, texto_1))
else:
    print('{} tienen la misma cantiad de letras que {}'.format(texto_1, texto_2))
...
if texto_1[0] > texto_2[0]:
    ...
    print('La primer letra de {} es mayo a la primer letra de {}'.format(texto_1, texto_2))
else:
...
if copia_texto_1 != texto_2:
    print('copia_texto_1 es distintade texto_2')
else:
    print('Terminamos!!!!!')
